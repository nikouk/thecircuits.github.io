...
$('.js-4').attr('src', (dpi>1) ? 'images/single-cover-546-1.jpg' : 'images/single-cover-273-1.jpg');
...
$('.js-9').attr('src', (dpi>1) ? 'images/circuits-1-536-1.jpg' : 'images/circuits-1-268-1.jpg');
$('.js-10').attr('src', (dpi>1) ? 'images/circuits-vision-536-1.jpg' : 'images/circuits-vision-268-1.jpg');
$('.js-11').attr('src', (dpi>1) ? 'images/7th-13-536-1.jpg' : 'images/7th-13-268-1.jpg');}else{$('.js-2').attr('src', (dpi>1) ? 'images/asset-2-160.png' : 'images/asset-2-80.png');
$('.js-4').attr('src', (dpi>1) ? 'images/single-cover-260-1.jpg' : 'images/single-cover-130-1.jpg');
...
$('.js-9').attr('src', (dpi>1) ? 'images/circuits-1-202-1.jpg' : 'images/circuits-1-101-1.jpg');
$('.js-10').attr('src', (dpi>1) ? 'images/circuits-vision-202-1.jpg' : 'images/circuits-vision-101-1.jpg');
$('.js-11').attr('src', (dpi>1) ? 'images/7th-13-202-1.jpg' : 'images/7th-13-101-1.jpg');}}};
if(!window.HTMLPictureElement){$(window).resize(r);r();}
if(! document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")) {
$('.js-23').attr('src', 'images/us-uk_apple_music_badge_rgb-118-1.png');
$('.js-24').attr('src', 'images/apple_music_icon_blk-43-1.png');
