...
$('.js-10').attr('src', (dpi>1) ? 'images/circuits-vision-536.jpg' : 'images/circuits-vision-268.jpg');}else{$('.js-2').attr('src', (dpi>1) ? 'images/asset-2-116.png' : 'images/asset-2-58.png');
...
$('.js-9').attr('src', (dpi>1) ? 'images/circuits-1-138.jpg' : 'images/circuits-1-69.jpg');
$('.js-10').attr('src', (dpi>1) ? 'images/circuits-vision-138.jpg' : 'images/circuits-vision-69.jpg');}}};
if(!window.HTMLPictureElement){$(window).resize(r);r();}
if(! document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1")) {
$('.js-21').attr('src', 'images/us-uk_apple_music_badge_rgb-118.png');
$('.js-22').attr('src', 'images/apple_music_icon_blk-43.png');
